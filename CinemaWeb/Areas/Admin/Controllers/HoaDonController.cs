...
namespace CinemaWeb.Areas.Admin.Controllers
{
    ...
    public class HoaDonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHD,Username,VeDaDat,TongTien,Ngay,TrangThai")] HoaDonModel hoaDonModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHD,Username,VeDaDat,TongTien,Ngay,TrangThai")] HoaDonModel hoaDonModel)
        {
